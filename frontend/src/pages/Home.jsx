...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const iv = setInterval(() => {
      ctx.fillStyle = "rgba(4,13,28,0.04)";
      ctx.fillRect(0, 0, canvas.width, canvas.height);
      ctx.fillStyle = "#00b8ff22";
        ...
        >
          ...
          <h1
            style={{
              ...
              lineHeight: 1,
              color: "var(--accent)",
              textShadow: "0 0 40px var(--accent2)",
          ...
          >
            <p style={{ color: "var(--text)", lineHeight: 1.75 }}>
              Hackers are everywhere. Threats are real.
              <br />
              Be smart. Be secure.{" "}
          ...
          >
            <button
              ...
              style={{
                ...
                fontSize: 14,
                letterSpacing: 2,
                boxShadow: "0 0 24px rgba(0,230,118,.35)",
              }}
            >
            ...
            >
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.background = "rgba(255,214,0,.05)";
                }}
                onMouseLeave={(e) => {
          ...
          {leaderboard.map((entry, i) => (
            <div
              ...
              style={{
                ...
                gap: "0 8px",
                padding: "9px 8px",
                borderBottom: "1px solid rgba(26,53,96,.4)",
