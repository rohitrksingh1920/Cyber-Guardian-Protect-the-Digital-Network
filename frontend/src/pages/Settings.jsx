...
export default function Settings() {
  ...
  const [animations, setAnimations] = useState(
    () => localStorage.getItem("cg-anim") !== "false",
  );
    ...
    <div style={{ minHeight: "100vh", animation: "fadeIn .35s ease" }}>
      ...
      <div style={{ padding: "24px 32px", maxWidth: 760, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <p style={{ color: "var(--text-dim)", marginTop: 5, fontSize: 13 }}>
            Customize your agent profile and experience
          </p>
        </div>
          ...
          {TABS.map((t) => (
            <button
              ...
              style={{
                padding: "8px 16px",
                background:
                  activeTab === t.id ? "var(--accent2)" : "transparent",
          ...
          <>
            <div
              style={{
                ...
                marginBottom: 16,
                background:
                  "linear-gradient(135deg,rgba(0,85,204,.15),rgba(0,184,255,.07))",
                ...
                {AVATARS.map((a) => (
                  <button
                    ...
                    style={{
                      ...
                      background:
                        avatar === a ? "rgba(0,184,255,.15)" : "transparent",
                      cursor: "pointer",
                      transition: "var(--transition)",
                      transform: avatar === a ? "scale(1.12)" : "scale(1)",
                      boxShadow:
                        avatar === a ? "0 0 14px rgba(0,184,255,.4)" : "none",
                    }}
                  >
                    {a}
                  </button>
        ...
        {activeTab === "gameplay" && (
          <div style={cardStyle}>
            ...
            <Row
              label="Sound Effects"
              sub="In-game threat alert and action sounds"
            >
              <Toggle
                value={soundFX}
                onChange={setSoundFX}
            ...
            <Row
              label="Animations"
              sub="Page transitions, card animations, and visual effects"
            >
              <Toggle
                value={animations}
            ...
            <Row
              ...
              sub="Show a cybersecurity tip on the dashboard each day"
            >
              <Toggle
                value={dailyTips}
            ...
            >
              💡 Gameplay preferences are saved locally on your device and apply
              instantly.
            </div>
          </div>
        )}
            ...
            <div style={{ ...cardStyle, marginBottom: 16 }}>
              ...
              >
                {[
                  ...
                  {
                    label: "Total Score",
                    val: user.total_score.toLocaleString(),
                    color: "var(--green)",
                  },
                  {
                    label: "School Code",
                    val: user.school_code || "Not set",
                    color: "var(--purple)",
                  },
                ].map((s) => (
                ...
                {[1, 2, 3, 4, 5, 6].map((lvl) => (
                  <div
                    ...
                    style={{
                      ...
                      gap: 12,
                      padding: "6px 0",
                      borderBottom: "1px solid rgba(26,53,96,.2)",
                    }}
                  >
                    <span
                      style={{
        ...
        {activeTab === "privacy" && (
          <div style={cardStyle}>
            ...
            <Row
              ...
              sub="Your username and score will be visible to all players worldwide"
            >
              <Toggle
                value={showOnBoard}
                onChange={setShowOnBoard}
                color="var(--accent)"
              />
            </Row>
            <Row
              ...
              sub={
                <>
                  Join your school's private leaderboard. Ask your teacher for
                  the code.
                  <br />
                  <span style={{ color: "var(--accent)", fontSize: 11 }}>
                    Example: KRMU2026, DPS2025, IITD2026
                  </span>
                </>
              }
            >
            ...
            >
              🏫 <strong style={{ color: "var(--text)" }}>School Code</strong>{" "}
              allows your teacher or institution to view your progress on a
              private leaderboard. Only users with the same code can see each
              other.
              <br />
              🔒 Your email is never shown publicly. Only your username and
              score appear on leaderboards.
            </div>
          </div>
        )}
        ...
        {activeTab === "danger" && (
          <div style={{ ...cardStyle, borderColor: "rgba(255,23,68,.3)" }}>
            ...
            <Row
              ...
              sub="Permanently wipe all scores, XP, achievements and level progress. This cannot be undone."
              danger
            >
              {!resetConfirm ? (
                <button
                ...
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      toast.info(
                        "Reset",
                        "Please contact support to reset your progress.",
                      );
                    }}
                  >
                    CONFIRM
            ...
            <Row
              label="Sign Out"
              sub="Log out of your Cyber Guardian account on this device"
              danger
            >
              <button
                className="btn-danger"
            ...
            >
              ⚠️ Actions in this section are permanent. Please think carefully
              before proceeding.
            </div>
          </div>
        )}
