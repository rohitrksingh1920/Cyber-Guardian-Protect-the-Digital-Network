...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      api
        .get("/achievements/")
        .then((r) => setAchiev(r.data.filter((a) => a.unlocked).slice(0, 4)))
        .catch(() => {}),
      api
        ...
        >
          <div>
            ...
            <p style={{ color: "var(--text-dim)", fontSize: 13, marginTop: 4 }}>
              ...
              {myRank && (
                <span style={{ marginLeft: 10 }} className="badge badge-gold">
                  #{myRank} Global
                </span>
              )}
            </p>
          </div>
          <button className="btn-green" onClick={() => navigate("/levels")}>
            ▶ PLAY NOW
          </button>
        </div>
        ...
        <div className="grid-2" style={{ gap: 20 }}>
          ...
          >
            ...
            >
              <div
                style={{
                  fontSize: 48,
                  filter: `drop-shadow(0 0 12px ${meta.color})`,
                }}
              >
                {meta.icon}
              </div>
              <div>
                ...
                >
                  {lvl < 6
                    ? `${6 - lvl} level${6 - lvl > 1 ? "s" : ""} remaining`
                    : "🏆 All levels reached!"}
                </div>
              </div>
            </div>
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <button className="btn-ghost" onClick={() => navigate("/levels")}>
                ALL LEVELS
              </button>
            </div>
          </Card>
            ...
            {!loaded ? (
              ...
              <div className="empty-state" style={{ padding: "20px 0" }}>
                ...
                <div style={{ fontSize: 12, color: "var(--text-dim)" }}>
                  Complete levels to earn medals!
                </div>
              </div>
            ) : (
              achiev.map((a, i) => (
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(255,214,0,.13)",
                    borderRadius: 8,
                    marginBottom: 7,
                    animation: `fadeIn .35s ${i * 0.06}s ease both`,
                  }}
                >
          ...
          <Card style={{ animation: "fadeIn .5s ease" }}>
            ...
            {board.length === 0 ? (
              ...
              board.map((e, i) => {
                ...
                const rc =
                  ["#ffd600", "#b0bec5", "#bf7c3a"][i] || "var(--text-dim)";
                return (
                  <div
                    key={e.rank}
                    style={{
                      ...
                      borderRadius: 8,
                      marginBottom: 5,
                      background: isMe ? "rgba(0,184,255,.08)" : "transparent",
                      border: `1px solid ${isMe ? "rgba(0,184,255,.25)" : "transparent"}`,
                      animation: `fadeIn .35s ${i * 0.06}s ease both`,
                    }}
                  >
                    <div
          ...
          <Card style={{ animation: "fadeIn .55s ease" }}>
            ...
            {[
              {
                label: "🎮 Level Select",
                sub: "Choose your next mission",
                path: "/levels",
              },
              {
                label: "🏅 Achievements",
                sub: `${achiev.length} unlocked`,
                path: "/achievements",
              },
              {
                label: "📊 Leaderboard",
                sub: myRank ? `You are ranked #${myRank}` : "Top agents",
                path: "/leaderboard",
              },
              {
                label: "⚙ Settings",
              ...
              <button
                ...
                style={{
                  ...
                  marginBottom: 8,
                  animation: `fadeIn .35s ${i * 0.07}s ease both`,
                }}
                onMouseEnter={(e) => {
