...
function ProtectedRoute({ children }) {
  ...
  if (loading) return (
    <div style={{ display:'flex', justifyContent:'center', alignItems:'center', height:'100vh', color:'var(--accent)', fontFamily:'var(--font-head)', flexDirection:'column', gap:16 }}>
    ...
    <AuthProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/level/6"      element={<ProtectedRoute><Level6 /></ProtectedRoute>} />
