      ...
      {pieces.map((p) => (
        <div
          ...
          style={{
            ...
            background: p.color,
            animation: `cFall 1.3s ${p.delay}s ease-in forwards`,
            opacity: 0,
          }}
        />
      ))}
    ...
    >
      <div
        style={{
          ...
          border: `1px solid ${isLevelUp ? "var(--gold)" : "var(--accent)"}`,
          borderRadius: 14,
          padding: "40px 48px",
          maxWidth: 500,
          width: "90%",
      ...
      >
        ...
        {isLevelUp && (
          <div
            style={{
              ...
              fontSize: 12,
              letterSpacing: 1,
              animation: "pop .5s .15s cubic-bezier(0.34,1.56,0.64,1) both",
            }}
          >
        ...
        >
          <div>
            ...
            >
              {result.new_total_xp?.toLocaleString()}
            </strong>
          </div>
          <div>
            Score{" "}
            <strong
              style={{ color: "var(--text)", fontFamily: "var(--font-head)" }}
            >
              {result.new_total_score?.toLocaleString()}
            </strong>
          </div>
        </div>
            ...
            {result.achievements_unlocked.map((a, i) => (
              <div
                ...
                style={{
                  ...
                  color: "var(--gold)",
                  marginBottom: 5,
                  animation: `pop .4s ${0.1 + i * 0.1}s cubic-bezier(0.34,1.56,0.64,1) both`,
                }}
              >
                🏅 {a}
              </div>
        ...
        >
          ...
          {levelNum && levelNum < MAX_LEVEL && (
            <button
              ...
              onClick={() => navigate(`/level/${levelNum + 1}`)}
            >
              NEXT LEVEL →
            </button>
          )}
