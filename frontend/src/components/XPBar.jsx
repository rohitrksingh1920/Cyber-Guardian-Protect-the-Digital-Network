  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      >
        ...
        <span>
          {current.toLocaleString()} / {XP_PER} XP
        </span>
      </div>
      <div
        style={{
      ...
      >
        <div
          style={{
            ...
            width: `${width}%`,
            background:
              "linear-gradient(90deg,var(--accent2),var(--accent),#00dfff)",
            borderRadius: 4,
            transition: animated
              ? "width .9s cubic-bezier(0.4,0,0.2,1)"
              : "none",
            boxShadow: width > 5 ? "0 0 12px var(--accent)" : "none",
          }}
        />
      </div>
      <div
